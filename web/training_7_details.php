                ...
                <div class="col-lg-8">
                        ...
                        <div class="single_trainings white-bg d-flex justify-content-between">
                            <div class="trainings_left d-flex align-items-center">
                                ...
                                <div class="trainings_conetent">
                                    <a href="#"><h4>Силовая тренировка на корпус и руки</h4></a>
                    ...
                    <div class="descript_wrap white-bg">
                        <div class="single_wrap">
                            ...
                            <p> Силовая тренировка, акцент на корпус и руки. </p>
                        </div>
                        <div class="single_wrap">
                            <h4>Программа тренировки</h4>
                            <ul>
                                <li>4 круга. Пауза между кругами 1-2 минуты. Пауза отдыха между упражнениями не больше 20 секунд.
                                </li>
                                <li>1. Отжимания повторений</li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/59.mp4" type="video/mp4">
                                </video>
                                <li>2. Приседания повторений </li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/43.mp4" type="video/mp4">
                                </video>
                                <li>3. V-планка </li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/03.mp4" type="video/mp4">
                                </video>
                                <li>4.Планка на локтях </li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/04.mp4" type="video/mp4">
                                </video>
                                <li>5. Берпи повторений</li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/64.mp4" type="video/mp4">
                                </video>
                                <li>6. Выпады вперед</li>
                                <video width="320" height="240" controls muted="muted">
