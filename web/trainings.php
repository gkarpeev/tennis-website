            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="training_filter white-bg">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="single_field">
                                            <input type="text" placeholder="Найти по ключевому слову">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="single_field">
                                            <select class="wide">
                                                ...
                                                <option value="1">Легкая Тренировка</option>
                                                <option value="2">Средняя Тренировка</option>
                                                <option value="3">Сложная Тренировка</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="single_field">
                                            <select class="wide">
                                                <option data-display="Типы тренировок">Типы тренировок</option>
                        ...
                        <div class="reset_btn">
                            <button  class="boxed-btn3 w-100" type="submit">Сбросить</button>
                        </div>
                    </div>
                </div>
                <div class="col-lg-9">
