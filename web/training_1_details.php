                        ...
                        <div class="single_trainings white-bg d-flex justify-content-between">
                            <div class="trainings_left d-flex align-items-center">
                                ...
                                <div class="trainings_conetent">
                                    <a href="#"><h4>Силовая тренировка на руки и ноги</h4></a>
                    ...
                    <div class="descript_wrap white-bg">
                        ...
                        <div class="single_wrap">
                            ...
                            <ul>
                                ...
                                <li>1. Отжимания: 15 повторений </li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/59.mp4" type="video/mp4">
                                </video>
                                <li>2. Статодинамические приседания: 15 повторений </li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/35.mp4" type="video/mp4">
                                </video>
                                <li>3. Погружения на трицепс: 10 повторений</li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/63.mp4" type="video/mp4">
                                </video>
                                <li>4. Выпады назад с выносом бедра: 15 повторений </li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/36.mp4" type="video/mp4">
                                </video>
                                <li>5. Отжимания: 15 повторений</li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/59.mp4" type="video/mp4">
                                </video>
                                <li>6. Выпады вперед: 15 повторений</li>
                                <video width="320" height="240" controls muted="muted">
