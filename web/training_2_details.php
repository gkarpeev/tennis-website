                ...
                <div class="col-lg-8">
                        ...
                        <div class="single_trainings white-bg d-flex justify-content-between">
                            <div class="trainings_left d-flex align-items-center">
                                ...
                                <div class="trainings_conetent">
                                    <a href="#"><h4>Силовая тренировка на корпус и ноги</h4></a>
                    ...
                    <div class="descript_wrap white-bg">
                        ...
                        <div class="single_wrap">
                            ...
                            <ul>
                                <li>3 круга. Пауза между кругами 2 минуты. Пауза отдыха между упражнениями не больше 20 секунд.
                                </li>
                                <li>1. Статодинамические приседания: 20 повторений</li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/35.mp4" type="video/mp4">
                                </video>
                                <li>2. Подъем одной ноги лежа на спине: 10 повторений</li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/49.mp4" type="video/mp4">
                                </video>
                                <li>3. Подъем туловища и одной ноги 12 повторений</li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/32.mp4" type="video/mp4">
                                </video>
                                <li>4. Боковая планка 45 секунд </li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/06.mp4" type="video/mp4">
                                </video>
                                <li>5. Выпады вперед 15 повторений</li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/37.mp4" type="video/mp4">
                                </video>
                                <li>6. #56 Ласточка 60 секунд </li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/56.mp4" type="video/mp4">
                                </video>
                            </ul>
                        </div>
                        <!-- <div class="single_wrap">
                    ...
                    <div class="training_sumary">
                        ...
                        <div class="training_content">
                            <ul>
                                ...
                                <li>Сложность: <span>Легкая</span></li>
                                <li>Количество упражнений: <span>6</span></li>
                                <li>Время выполнения: <span> ~45 минут</span></li>
                            </ul>
                        </div>
                    </div>
