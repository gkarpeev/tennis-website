                ...
                <div class="col-lg-8">
                        ...
                        <div class="single_trainings white-bg d-flex justify-content-between">
                            <div class="trainings_left d-flex align-items-center">
                                ...
                                <div class="trainings_conetent">
                                    <a href="#"><h4>Силовая тренировка на корпус</h4></a>
                    ...
                    <div class="descript_wrap white-bg">
                        ...
                        <div class="single_wrap">
                            ...
                            <ul>
                                <li>3 круга. Пауза между кругами 3 минуты. Пауза отдыха между упражнениями не больше 30 секунд.
                                </li>
                                ...
                                <li>2. V – планка: 40 секунд </li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/03.mp4" type="video/mp4">
                                </video>
                                <li>3. Классическая планка с движением в тазобедренном суставе: 6 повторений</li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/09.mp4" type="video/mp4">
                                </video>
                                <li>4. Касание руками стоп лежа на спине: 15 повторений</li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/21.mp4" type="video/mp4">
                                </video>
                                <li>5. Скручивания лежа на спине, ноги под углом 90 градусов: 40 секунд</li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/28.mp4" type="video/mp4">
                                </video>
                                <li>6. Подъем таза: 20 повторений</li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/47.mp4" type="video/mp4">
                                </video>
                                <li>7. Скручивание разноименных рук и ног: 12 повторений</li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/53.mp4" type="video/mp4">
                                </video>
                                <li>8. Поза "супермен" в статике: 30 секунд</li>
                                <video width="320" height="240" controls muted="muted">
                    ...
                    <div class="training_sumary">
                        ...
                        <div class="training_content">
                            <ul>
                                ...
                                <li>Сложность: <span>Средняя</span></li>
                                <li>Количество упражнений: <span>8</span></li>
                                <li>Время выполнения: <span> ~1 час</span></li>
                            </ul>
                        </div>
                    </div>
