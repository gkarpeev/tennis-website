        ...
        <div class="col-lg-8">
          <form class="form-contact contact_form" action="contact_process.php" method="post" id="contactForm" novalidate="novalidate">
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <input class="form-control" name="email" id="email" type="email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Введите Вашу эл. почту'" placeholder = 'Введите Вашу эл. почту'>
                </div>
              </div>
              <div class="col-12">
                <div class="form-group">
        ...
        <div class="col-lg-4">
          <div class="media contact-info">
            ...
            <div class="media-body">
              <h3>Чебоксары, Чувашская Республика</h3>
          ...
          <div class="media contact-info">
            ...
            <div class="media-body">
              <h3>+7 (906) 380-50-27</h3>
              <p>С Пн по Пт с 9 до 18</p>
            </div>
          </div>
          <div class="media contact-info">
            <span class="contact-info__icon"><i class="ti-email"></i></span>
            <div class="media-body">
              <h3>glebkarpeev046@gmail.com</h3>
