                ...
                <div class="col-lg-8">
                        ...
                        <div class="single_trainings white-bg d-flex justify-content-between">
                            <div class="trainings_left d-flex align-items-center">
                                ...
                                <div class="trainings_conetent">
                                    <a href="#"><h4>Силовая тренировка на руки</h4></a>
                    ...
                    <div class="descript_wrap white-bg">
                        <div class="single_wrap">
                            ...
                            <p> Силовая тренировка, акцент на руки. </p>
                        </div>
                        <div class="single_wrap">
                            ...
                            <ul>
                                ...
                                <li>1. Берпи с отжиманием: 7 повторений</li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/64.mp4" type="video/mp4">
                                </video>
                                <li>2. Отжимания из положения планки на локтях: 5 повторений </li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/20.mp4" type="video/mp4">
                                </video>
                                <li>3. Отжимания широким хватом: 7 повторений</li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/61.mp4" type="video/mp4">
                                </video>
                                <li>4. Погружения на трицепс: 12 повторений</li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/63.mp4" type="video/mp4">
                                </video>
                                <li>5. Берпи с отжиманием: 7 повторений</li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/64.mp4" type="video/mp4">
                                </video>
                                <li>6. Отжимания "спайдермен": 8 повторений</li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/62.mp4" type="video/mp4">
                                </video>
                                <li>7. Отжимания с выпрыгиванием: 7 повторений</li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/60.mp4" type="video/mp4">
                                </video>
                                <li>8. Погружения на трицепс: 12 повторений</li>
                                <video width="320" height="240" controls muted="muted">
                                    <source src="trainings/strength_complex/63.mp4" type="video/mp4">
                                </video>
                            </ul>
